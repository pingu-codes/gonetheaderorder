...
func (c *Client) send(req *Request, deadline time.Time) (resp *Response, didTimeout func() bool, err error) {
	...
	//if HeaderOrderKey is presesnt don't write cookies since ya know they need to be ordered
	if req.Header[HeaderOrderKey] == nil {
		if c.Jar != nil {
			for _, cookie := range c.Jar.Cookies(req.URL) {
				fmt.Println("add cookie client")
